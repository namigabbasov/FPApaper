...
library(haven)
library(readxl)
region2013<-read_dta("/Users/namigabbasov/Library/Mobile Documents/com~apple~CloudDocs/Research Projects/Pub Opinion in SC/Clean data/CB/CB2013_Regional_only_responses_07032014.dta")
region2015<-read_dta("/Users/namigabbasov/Library/Mobile Documents/com~apple~CloudDocs/Research Projects/Pub Opinion in SC/Clean data/CB/CB_2015_Regional_Only_Responses_140416.dta") 
region2017<-read_dta("/Users/namigabbasov/Library/Mobile Documents/com~apple~CloudDocs/Research Projects/Pub Opinion in SC/Foreign Policy Preferences/Replication Files/CB_2017_Regional_Only_Responses_20.11.18.dta")     
region2019<-read_dta("/Users/namigabbasov/Library/Mobile Documents/com~apple~CloudDocs/Research Projects/Pub Opinion in SC/Clean data/CB/cb2019_CB_2019_Regional_25.06.2020.dta")          
EU2021<-read_dta("/Users/namigabbasov/Library/Mobile Documents/com~apple~CloudDocs/Research Projects/Pub Opinion in SC/Clean data/EU Survey/EU_2021_Public.dta")
NDI2022M<-read_dta("/Users/namigabbasov/Library/Mobile Documents/com~apple~CloudDocs/Research Projects/Pub Opinion in SC/Clean data/NDI/NDI_March_2022_NDI_March_2022_8.04.2022_Public.dta")
trade<-read_excel("/Users/namigabbasov/Library/Mobile Documents/com~apple~CloudDocs/Research Projects/Pub Opinion in SC/Foreign Policy Preferences/Replication Files/trade_vol.xlsx")                  
```
...
is.na(region2019$MONYTOT) <- which(region2019$MONYTOT==-2)
is.na(region2019$MONYTOT) <- which(region2019$MONYTOT==-9)
region2019$income<-Recode(region2019$MONYTOT, "9=1; 8=2; 7=3; 6=4; -1=5; 5=5; 4=6; 3=7; 2=8;1=9")
